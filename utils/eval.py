...
parser.add_argument('--pred-file', type=str, required=False, default="/mnt/zpq/drug_combo_spert_final1/outputs/final_predictions.jsonl", help="Path to the predictions file")
...
if __name__ == "__main__":
    ...
    with open("/mnt/zpq/drug_combo_spert_final1/aaa.json") as f:
        pred = [json.loads(l) for l in f.readlines()]
    with open("/mnt/zpq/drug_combo_spert_final1/test_pred.jsonl") as f:
